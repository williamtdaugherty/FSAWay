namespace FsaWayApp.Controllers {
    ...
    export class AccountController {
        ...
        constructor(private accountService: FsaWayApp.Services.AccountService, private $location: ng.ILocationService) {
    ...
    angular.module('FsaWayApp').controller('AccountController', AccountController);
    ...
    export class ExternalLoginController {
        ...
        constructor($http: ng.IHttpService, private $location: ng.ILocationService, private accountService: FsaWayApp.Services.AccountService) {
